...
/**
 * Demonstracija cetvrtog zadatka 4. lab vjezbe iz OOP2015.
 *
 */
public class Demonstration {
	...
	public static void main(String[] args) throws NotEligiblePlayerException, NotPlayableMatchException {
		...
		System.out.println("Klub i nacionalni tim imaju igrace jednakih kvaliteta i emocija... Tko pobjedjuje?\nNacionalni tim je domacin.");
		...
		System.out.println("HOME(%):" + (float)noHomeWins / NO_MATCHES + ", DRAWS(%):" + (float)noDraws / NO_MATCHES + ", AWAY(%):"
				+ (float)noAwayWins / NO_MATCHES);
